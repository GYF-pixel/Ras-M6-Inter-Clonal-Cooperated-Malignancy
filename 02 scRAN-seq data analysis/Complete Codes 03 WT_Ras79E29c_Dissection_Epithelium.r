...
getwd()
setwd("I:/M6")
scRNAsub <- readRDS("CCA_WTR79_UniqueClusters_reclustered_Epithelium.Rds")
...
##设置对应cluster的配色数目
col5 <- colorRampPalette((pal_npg(palette = c("nrc"))(7)))(18)
show_col(col5)
...
ggsave("P3_scRNAsubUMAP1_GFPplot2.pdf", plot = plot_grid(a), width = 6, height = 5)
...
ggsave("P3_scRNAsubUMAP1_Ras85Dplot2.pdf", plot = plot_grid(a), width = 6, height = 5)
...
ggsave("P3_scRNAsubUMAP1_M6plot2.pdf", plot = plot_grid(a), width = 6, height = 5)
...
ggsave("P3_scRNAsubUMAP1_GAL80plot2.pdf", plot = plot_grid(a), width = 6, height = 5)
...
ggsave("P3_scRNAsubUMAP1_pucplot2.pdf", plot = plot_grid(a), width = 6, height = 5)
...
ggsave("P3_scRNAsubUMAP1_Jraplot2.pdf", plot = plot_grid(a), width = 6, height = 5)
...
ggsave("P3_scRNAsubUMAP1_kayplot2.pdf", plot = plot_grid(a), width = 6, height = 5)
##GFP细胞在各个Cluster中的占比
